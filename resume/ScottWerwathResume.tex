...
\end{rSubsection}
\begin{rSubsection}{Academic Intern, Course Reader}{January 2016\textminus Present}{UC Berkeley, Electrical Engineering Division}{Berkeley, CA}
...
\item[] Maintained code base for wireless dosimeters to monitor real-time radiation levels in the Bay Area, Fukushima, South Korea, and beyond.
