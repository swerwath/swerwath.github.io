...
Languages & Python, C\#, Javascript, Ruby, HTML5, Elixir \\
Frameworks & Rails, Node, .NET, MPI, NumPy \\
\end{tabular}
...
\item[] Designed and built centralized web socket server for use by multiple customer-facing applications
\item[] Refactored customer-facing API to use asynchronous programming
\end{rSubsection}
