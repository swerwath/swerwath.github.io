...
\item[] Developing novel NLP techniques to solve the Entity Linking problem using Knowledge Graph
\item[] Implementing Entity Linking techniques to improve the accuracy of Google's information gathering
\end{rSubsection}
